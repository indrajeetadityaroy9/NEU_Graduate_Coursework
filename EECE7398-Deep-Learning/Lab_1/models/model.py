...
class CNNClassifier(nn.Module):
    ...
    def forward(self, x):
        ...
        res1_out = self.res1_relu(res1_out)  # ReLU after the first convolution
        res1_out = self.res1_conv2(res1_out)
        res1_out = self.res1_relu(res1_out)  # ReLU after the second convolution
        ...
        res2_out = self.res2_relu(res2_out)  # ReLU after the first convolution
        res2_out = self.res2_conv2(res2_out)
        res2_out = self.res2_relu(res2_out)  # ReLU after the second convolution
